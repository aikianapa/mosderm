    ...
    <div class="container">
        ...
        <div class="spec-reviews__slider" data-wb-role="foreach" data-wb-tpl="false" data-wb-count="3" data-wb-hide="wb">
            <div class="spec-reviews__slider-item-wrap">
                <div class="spec-reviews__slider-wrap flex" data-wb-role="foreach" data-wb-tpl="false" data-wb-limit="2" data-wb-form="news" data-wb-where='active="on" AND id NOT_IN_ARRAY({{_VAR[exclude]}})' data-wb-sort="date:d" data-wb-hide="wb">
