    <section id="news" data-name="Виджет новостей">
        ...
        <div class="container">
            ...
            <div class="news__wrap flex">
                <div class="news__first-block" data-wb-role="foreach" data-wb-form="news" data-wb-limit="4" data-wb-sort="date:d" data-wb-tpl="false"  data-wb-where='active = "on"' data-wb-hide="wb">
