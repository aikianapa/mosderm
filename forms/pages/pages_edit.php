...
<form id="pagesEditForm" data-wb-form="{{_form}}" data-wb-item="{{_item}}"  class="form-horizontal" role="form" >
    ...
    <div class="input-group col-sm-9">
      ...
      <input type="text" class="form-control" name="id" value="{{_item}}" placeholder="{{_LANG[page]}}" required>
    </div>
	</div>
  ...
  <div class="form-group row">
    ...
    <div class="form-group row">
	  <label class="col-sm-3 form-control-label">{{_lang[header]}}</label>
	   <div class="col-sm-9"><input type="text" class="form-control" name="header" placeholder="{{_lang[header]}}" ></div>
	</div>
...
<script>
$('#pagesEditForm [name=id]').trigger('click');
</script>